...
IL_01db:
	{
		...
		*((float*)L_60) = (float)((float)il2cpp_codegen_subtract((float)L_61, (float)L_63));
		...
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_67 = MixedRealityToolkitVisualProfiler_CalculateFrameColor_m566A73B97286EBE0F05BF0FF1E0EFE617E41C19F(__this, (((int32_t)((int32_t)(int32_t)L_66))), /*hidden argument*/NULL);
